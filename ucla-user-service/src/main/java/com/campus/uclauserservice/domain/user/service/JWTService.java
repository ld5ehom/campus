package com.campus.uclauserservice.domain.user.service;
...
import com.campus.uclauserservice.domain.user.repository.UserLoginHistoryRepository;
import com.campus.uclauserservice.domain.user.repository.UserRepository;
...
//build.gradle_ implementation 'io.jsonwebtoken:jjwt:0.12.5'
@Service
@Slf4j  // parseJwtClaims
