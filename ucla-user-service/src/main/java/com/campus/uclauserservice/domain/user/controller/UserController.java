package com.campus.uclauserservice.domain.user.controller;

import com.campus.uclauserservice.domain.user.dto.PasswordChangeDTO;
import com.campus.uclauserservice.domain.user.dto.UserDTO;
import com.campus.uclauserservice.domain.user.entity.User;
import com.campus.uclauserservice.domain.user.entity.UserLoginHistory;
import com.campus.uclauserservice.domain.user.exception.DuplicateUserException;
import com.campus.uclauserservice.domain.user.exception.UnauthorizedAccessException;
import com.campus.uclauserservice.domain.user.exception.UserNotFoundException;
import com.campus.uclauserservice.domain.user.service.UserService;
